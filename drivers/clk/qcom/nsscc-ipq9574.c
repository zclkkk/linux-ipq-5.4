...
static const struct freq_tbl ftbl_nss_cc_ubi0_clk_src[] = {
	F(1500000000, P_UBI32_PLL_OUT_MAIN, 1, 0, 0),
	F(1600000000, P_UBI32_PLL_OUT_MAIN, 1, 0, 0),
	F(1700000000, P_UBI32_PLL_OUT_MAIN, 1, 0, 0),
	{ }
};
